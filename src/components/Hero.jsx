  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="text-center mt-10 text-lg text-neutral-500 max-w-4xl">
            ...
            elit. Nobis nulla aspernatur ducimus consequuntur quam 
            quia consequatur tempore, eveniet necessitatibus earum?
        </p>
        ...
        <div className="flex mt-10 justify-center">
            <video autoPlay loop muted className='rounder-lg w-1/2 border 
                border-orange-200 shadow-orange-400 mx-2 my-4'>
